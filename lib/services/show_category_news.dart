...
class ShowCateoryNews {
  List<ShowCategoryModel> showCategory = [];

  Future<void> getShowCategory(String category) async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=us&category=$category&apiKey=055dfa92decc4711b2003ee4504cbf51";
